...
void hd_set_default_params(hd_params* params) {
	...
	params->beam            = 0;
	// NOTE: If set to false will subtract 1 from each beam number and we would end up with -1 for beam 0
	...
	params->dm_tol          = 1.25;
	params->dm_pulse_width  = 500;//e-6; // The expected intrinsic width of the pulse signal in microseconds
